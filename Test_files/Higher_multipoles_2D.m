...
H0 = [Hmag*sin(alpha) Hmag*cos(alpha)]'; % A/m
...
for l=1:L
    for m=0:1
        ...
        if m==0
            ...
            % Theta Component
            Hth=Hth+...
                (Beta1_0(l).*dPlm./(R.^(l+2)) + Beta2_0(l)*Hths);
            % R Component
            Hr=Hr+...
        ...
        elseif m==1
            ...
            % Theta Component
            Hth=Hth+...
                (Beta1_1(l).*dPlm./(R.^(l+2)) + Beta2_1(l)*Hths);
            % R Component
            Hr=Hr+...
